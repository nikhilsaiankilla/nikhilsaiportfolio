...
const getAllSkillsController = async (req, res) => {
    try {
        ...
        return res.status(500).send({
            success : false,
            error: error || "something went wrong while fetching all skills",
        });
    }
};
...
const addSkillsController = async (req, res) => {
    try {        
        ...
        return res.status(500).send({
            success : false,
            error: error || "An error occurred while adding the skill(s)",
        });
    }
};
...
const deleteSkillsController = async (req, res) => {
    try {
        ...
        return res.status(500).send({
            success : false,
            error: error || "An error occurred while deleting the skill",
        });
    }
};
